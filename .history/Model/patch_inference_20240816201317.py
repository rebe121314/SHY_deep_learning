...
class InferenceWithPatch:
    ...
    def generate_bounding_boxes(self, patch, properties, pred_boxes, pred_scores, criteria_labels, i_offset, j_offset):
        ...
        score_treshold = 0.1 # Has a low confidence threshold eg 0.5 to avoid false negatives and allow for manual elimination
...
model_path =  'data/saved_models/trans_with_relax.pth'
