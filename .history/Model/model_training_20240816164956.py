...
ACCESS_TOKEN = 'sl.B7HwNPZx3wglQM-t383WZTBeihVCiZ2Ol-GwJxbq4E4UWQhR9quDLsoe5VCHLnFLdlvs_Y4AFDx0OVLpgyn_R6i87pxLpoomhYrwOitiipPmcicskj7_iRKeko2YfhYXokI8kM9XOhNh'
...
class GranzymeBDataset(Dataset):
    ...
    def _load_images_and_labels(self):
        ...
        if self.val:
            ...
            label_files = sample(label_files, int(len_f*0.5))
...
if __name__ == "__main__":
    ...
    #manual_box_label
    labels_folder = '/Lables/extra_relax_manual_boxes'
    ...
    load_path = "data/saved_models/with_trans_longish.pth"
    ...
    save_path = "data/saved_models/extra_relax_basic_small.pth" 
