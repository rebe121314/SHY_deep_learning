...
class InferenceWithPatch:
    ...
    def generate_bounding_boxes(self, patch, properties, pred_boxes, pred_scores, criteria_labels, i_offset, j_offset):
        ...
        score_treshold = 0.5 # Has a low confidence threshold eg 0.5 to avoid false negatives and allow for manual elimination
    ...
    def run(self, example, image_name):
        ...
        for inform_file in inform_files:
            if inform_file.endswith('.xlsx'):
                ...
                image_name = image_name.split('_Granzyme')[0]
...
model_path =  "data/saved_models/transf_basic.pth"
patch_size = 256
