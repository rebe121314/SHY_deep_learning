...
ACCESS_TOKEN = 'sl.B6owKYbqwDg20pYIM4K1jlon-HhauIpJFRpO36rvGH-tNiT-7b_tr7Ht3AquOEaxBfWKmD5ZmsQgVwMI8ucIclnuQIi8GL9iE6gpqvfOeZ5QwpOZsJU9QhEAraGpvnDdXW1VqgMkoXlI'
...
if __name__ == "__main__":
    ...
    #load_path = "data/saved_models/simpie_then_manual.pth copy"
    ...
    # Train the model
    train(model, data_loader,data_val_loader, optimizer, scheduler, device, num_epochs=15)
    #fused
    #simpie_flexible_only_training.pth
    #lablemanual_and_then_simpie
    save_path = "data/saved_models/no_pretrained_simpie.pth copy" 
