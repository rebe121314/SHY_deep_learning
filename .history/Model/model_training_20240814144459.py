...
ACCESS_TOKEN = 'sl.B68p8s2KEopHtQnPbKzntYucmBkQFQpeX8wUOc7o4G6KlBysbDkkTdXa6lr3kszXjFs2NYY69HnehN7sae9o9U_NSMfTwtdqK2_A3MHZ68aE-K9NZkqQF7lbQOCLkQ-NVsRu5t1GtrRt'
...
if __name__ == "__main__":
    ...
    # Train the model
    train(model, data_loader,data_val_loader, optimizer, scheduler, device, num_epochs=2)
    #fused
