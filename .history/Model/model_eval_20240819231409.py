...
def model_evaluation(model, data_loader, device):
    ...
    print(overall_result.keys())
    recall_at_iou_50 = overall_result['mar_100_per_class'][0].item()


    print(overall_result['mar_100_per_class'])
...
def plot_patch_metrics(patch_metrics, overall_result):
    ...
    recalls_50 = [metric['mar_100_iou_0.50'].cpu().item() for metric in patch_metrics]
    ...
    plt.subplot(1, 3, 3)
    plt.hist(recalls_50, bins=10, color='purple', alpha=0.7)
