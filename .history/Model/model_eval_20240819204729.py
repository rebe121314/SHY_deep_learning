...
def model_evaluation(model, data_loader, device):
    ...
    # Update the metric with all predictions and targets at once
    ...
    # Plot Precision-Recall curve for mAP_50
...
def plot_precision_recall_curve(result):
