...
class InferenceWithThreshold:
                ...
                for image_file in relevant_images:
                    ...
                    if processed_data:
                        ...
                        try:
                            ...
                            if human_in_loop:
                                self.human_in_the_loop(gb_image, all_boxes, self.patch_size)
    ...
    def human_in_the_loop_update(self, image, valid_cells, patch_size):
        ...
        boxes = valid_cells['Bounding Box'].tolist()
        ...
        for patch, patch_boxes in self.create_patches(image, boxes, patch_size):
            ...
            augmented = self.get_train_transforms(image=patch, bboxes=patch_boxes, labels=patch_labels)
