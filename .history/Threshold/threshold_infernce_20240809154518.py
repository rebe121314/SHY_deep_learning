...
# Connect to Dropbox
ACCESS_TOKEN = 'sl.B6rD6GDXt5E8qBKJej_Ayd3l2HJ7cLDgnYhEKD2kULGwpOY0Dm-iO9MqCirE0XImKRS27bmMH0nYKTS1bUmqvNdieFya4NIyXXMtnVEWDfYqEETpjsL6zFV0mRaEtOHgHUUHucR_YZO7'
...
class InferenceWithThreshold:
    ...
    def generate_bounding_boxes(self, patch, properties, pred_boxes, pred_scores, criteria_labels, i_offset, j_offset):
        ...
        score_treshold = 0.80 # Has a low confidence threshold eg 0.5 to avoid false negatives and allow for manual elimination
...
model_path = 'data/saved_models/basic_manual.pth'
patch_size = 256
