...
class inFormModelEval:
    ...
    def generate_bounding_boxes(self, patch, criteria_labels, pred_boxes, pred_scores,i_offset, j_offset):
        ...
        relevant_rows['Cell X Position'] = pd.to_numeric(relevant_rows['Cell X Position'], errors='coerce')
        relevant_rows['Cell Y Position'] = pd.to_numeric(relevant_rows['Cell Y Position'], errors='coerce')
        #relevant_rows['Cell Y Position'].astype(int)
