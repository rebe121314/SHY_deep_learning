...
class inFormModelEval:
        ...
        for pred_box, score in zip(sorted_pred_boxes, sorted_pred_scores):
            ...
            for _, row in relevant_rows.iterrows():
                ...
                if row['Label'] == 'gb':
                    ...
                    self.false_positives += 1
        self.true_negative = len(relevant_rows) - self.true_positives - self.false_positives - self.false_negatives - self.non_matched_criteria
    ...
    def run_model_val(self):
        ...
        inform_files = np.random.choice(inform_files, 5)
